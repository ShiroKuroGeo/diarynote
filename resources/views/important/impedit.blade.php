...
@section('title', 'Edit Important Notes')
@section('dashboard')
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">Edit Important Notes</h3>
              </div>
              <!-- /.card-header -->
              <form action="{{ route('editImporant', ['id' => $impdata->id]) }}" method="post">
               @csrf   
              <div class="card-body">
                  <div class="form-group">
                    <input class="form-control" name="title" value="{{ $impdata->title }}" placeholder="Title:">
                  </div>
                  <div class="form-group">
                      <textarea name="subject" class="form-control">{{ $impdata->subject }}</textarea>
                  </div>
                </div>
              <!-- /.card-body -->
